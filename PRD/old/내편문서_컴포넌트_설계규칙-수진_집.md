...
| 요금 | 월 구독(Basic/Standard/Pro) | **건별 결제**: 내용증명 19,900 · 준비서면 49,000 · 반박서 69,000 · 소견서/항소이유서 99,000(v2.0) |
...
- action: copy / download / regenerate / save
...
- 가격: 내용증명 19,900 · 준비서면 49,000 · 반박서 69,000 · 소견서/항소이유서 99,000(v2.0)
...
- PaymentSummaryCard: docType, price, includedFeatures[], cta
...
### EmpathyBubble 🆕
- side: left / right (번갈아 배치)
- shape: pill(borderRadius 40), 풀폭 maxWidth ≈76%
- tone: translucent-on-navy
- 사용: 홈 공감 섹션 대화형 문구
